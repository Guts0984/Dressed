      ...
      >
        ...
        >
          ...
          <div style={{ padding: "48px 48px 40px" }}>
            ...
            >
              Hey {user.name || user.email}, thanks for signing up. Just click
              the button below to verify your email and get started. Link
              expires in{" "}
          ...
          >
            ...
            >
              If you didn&apos;t create an account with Dressed, you can safely
              ignore this email.
            </p>
          </div>
        </div>
